...
<div class="bg-white dark:bg-gray-800 p-6" x-data="{ candidateIndex: null }" x-init="candidateIndex = candidates.findIndex(c => c.id === candidate.id) + 1">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <!-- Left Column - Image and Social Share -->
        <div>
            <div class="relative aspect-[3/4] overflow-hidden rounded-lg mb-4">
                <img src="{{ $candidate->image_url }}" alt="{{ $candidate->name }}" class="object-cover w-full h-full">
            </div>
            ...
            <div class="mb-4">
                <button type="button"
                    ...
                    x-on:click.prevent="vote(candidateIndex)">
            ...
            <div class="flex justify-center space-x-4 mt-4">
                ...
                <a href="https://twitter.com/intent/tweet?url={{ url()->current() }}&text=Vote for {{ $candidate->name }}" target="_blank" class="text-blue-400 hover:text-blue-600">
        ...
        <div>
            <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">{{ $candidate->name }}</h2>
            <p class="text-xl text-gray-600 dark:text-gray-300 mb-4">{{ $candidate->title }}</p>
            ...
            <div class="mb-6">
                ...
                <p class="text-gray-600 dark:text-gray-400">{{ $candidate->focus_area }}</p>
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="flex space-x-4">
                    @foreach(json_decode($candidate->social_media) as $platform => $url)
            ...
            <!-- Gallery Section -->
            @if(isset($candidate->gallery) && count($candidate->gallery) > 0)
            <div class="mb-6">
            ...
            <!-- Quotes Section -->
            @if(isset($candidate->quotes) && $candidate->quotes)
            <div class="mb-6">
