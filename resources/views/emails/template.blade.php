...
<body style="background-color: #ccc">
    <div
        ...
        <section style="max-width: 42rem; background-color: #fff;">
            <header> <a href="#" style="">
                    <div
                        style="display: flex; justify-content: center; align-items: center ;text-align:center;padding:1rem;">

                        <img style="height: 40px;width: 40px;padding: 1rem"
                            src="https://mrsheritageinternational.com/wp-content/uploads/2023/06/logo-1.png"
                            alt="PAGEANT OF HERITAGE" />
                        <h2>PAGEANT OF HERITAGE</h2>
                    </div>
                </a>
            </header>

            {{-- <div
                style="height: 200px; background-color: #A25A01; width: 100%; color: #fff; display: flex; align-items: center; justify-content: center; flex-direction: column; gap: 1.25rem;">
            ...
            <main style="margin-top: 2rem; padding-left: 1.25rem; padding-right: 1.25rem;">
                <h4 style="color: #374151;">Dear [Participant's Name],</h4>
                ...
                <p style="color: #4b5563;">
                    ...
                    Thank you for submitting your application for the [Selected Competition] category in the Heritage
                    Pageants. We are delighted to have you participate in our global beauty competition that emphasizes
                    Peace, Environment, Tourism, Culture, and global Heritage (PETCH).<br />

                    Our team will carefully review and verify your application to ensure it meets our criteria. We
                    appreciate your patience during this process.<br />

                    We will keep you updated on the status of your application. In the meantime, feel free to explore
                    more about our mission and values on our website and connect with us on social media for the latest
                    news and updates.<br />
                ...
                <p style="margin-top: 2rem; color: #4b5563; ">
                    Thank you, <br />
                    The Heritage Pageants Team
                </p>
            </main>

            <footer style="margin-top: 2rem;">
                <div
                    style="height: 100px; width: 100%; color: #fff; display: flex; align-items: center; justify-content: space-around; gap: 1.25rem; text-transform: uppercase; font-weight: bold">
                ...
                <div
                    ...
                    <div style="text-align: center; display: flex; flex-direction: column; gap: 0.75rem;">
                        <h1 style="color: #A25A01; font-weight: bold;  font-size: 20px; letter-spacing : 2px;">
                            Get in touch
                        </h1>
                        ...
                        <a href="mailto:eplanetsg@gmail.com" style="color: #4b5563;" alt="eplanetsg@gmail.com">
                            eplanetsg@gmail.com,
                ...
                <div
                    ...
                    <p class="footertext">© 2024 mrsheritageinternational.com. All Rights Reserved.</p>
                </div>
            </footer>
        </section>
