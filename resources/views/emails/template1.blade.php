...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Nunito&display=swap" rel="stylesheet"><!--<![endif]-->
    <style>
        * {
...
<body class="body"
    style="font-family: Nunito, sans-serif;margin: 0; background-color: #d3d3d3; padding: 1rem 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
    <table class="nl-container" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation"
        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ffffff; max-width: 400px;
    margin: auto;">
        <tbody>
            <tr>
                <td>
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div class="alignment" align="left"
                                                                    ...
                                                                    <div style="max-width: 76.5px;"><img
                                                                            src="https://6b70fd6641.imgdist.com/pub/bfra/k6jb86y5/3wv/ptv/cqe/logo-1.png"
                                                                            style="display: block; height: auto; border: 0; width: 100%;"
                                                                            width="76.5" height="auto"></div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                <td class="column column-2" width="75%"
                                                    ...
                                                    <table class="heading_block block-1" width="100%" border="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <h1
                                                                    style="margin: 0; color: #a25a01; direction: ltr; font-family: 'Roboto', Tahoma, Verdana, Segoe, sans-serif; font-size: 38px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: left; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 45.6px;">
                                                            ...
                                                            <td class="pad">
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0; margin-bottom: 26px;">Thank you
                                                                        ...
                                                                        Culture, and global Heritage (PETCH).<br>Our
                                                                        team will carefully review and verify your
                                                                        application to ensure it meets our criteria. We
                                                                        appreciate your patience during this
                                                                        process.<br>We will keep you updated on the
                                                                        status of your application. In the meantime,
                                                                        feel free to explore more about our mission and
                                                                        values on our website and connect with us on
                                                                        social media for the latest news and updates.
                                                                    </p>
                                                                    <p style="margin: 0;">Thank you,<br>The Heritage
                                                                        Pageants Team</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <table class="heading_block block-2" width="100%"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <h1
                                                                    style="margin: 0; color: #010101; direction: ltr; font-family: 'Roboto', Tahoma, Verdana, Segoe, sans-serif; font-size: 40px; font-weight: normal; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 48px;">
                                                                    <span class="tinyMce-placeholder"
                                                                        style="word-break: break-word;">Download Mobile
                                                                        App</span>
                                                                </h1>
                                                            </td>
                                                        </tr>
                                    ...
                                    <table class="row-content stack" align="center" border="0" cellpadding="0"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="column column-2" width="33.333333333333336%"
                                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 5px; padding-top: 40px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
                                                    <table class="image_block block-1 mobile_hide" width="100%"
                                                        border="0" cellpadding="0" cellspacing="0"
                                                        role="presentation"
                                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                                                        <tr>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <table class="row-content stack" align="center" border="0" cellpadding="0"
                                        cellspacing="0" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-size: auto; color: #000000; width: 680px; margin: 0 auto;"
                                        width="680">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1" width="100%"
                                            ...
                                            <tr>
                                                <td class="column column-1" width="100%"
                                                    ...
                                                    <table class="heading_block block-1" width="100%"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                style="padding-bottom:20px;padding-left:10px;padding-right:10px;text-align:center;width:100%;">
                                                                <h1
                                                                    style="margin: 0; color: #3b3b3b; direction: ltr; font-family: 'Roboto', Tahoma, Verdana, Segoe, sans-serif; font-size: 18px; font-weight: normal; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 21.599999999999998px;">
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <a href="mailto:eplanetsg@gmail.com"
                                                                    style="color: #3b3b3b; text-decoration: none"
                                                                    alt="eplanetsg@gmail.com">
                                                                    eplanetsg@gmail.com,
                                                                    pageantofheritage@gmail.com
                                                                </a>
                                                            </td>
                                                        </tr>
                                                    </table>
                    ...
                    <table class="row row-9" align="center" width="100%" border="0" cellpadding="0"
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div
                                        style="background-color: #A25A01; padding-top :10px; padding-bottom : 10px; color: #fff; text-align: center;">
                                        <p class="footertext">© 2024 mrsheritageinternational.com. All Rights Reserved.
                                        </p>
                                    </div>
                                </td>
                            </tr>
