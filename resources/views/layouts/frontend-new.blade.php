                ...
                <div class="hidden sm:flex sm:items-center sm:space-x-1">
                    <a href="/" class="nav-link-hover group px-4 py-2">
                        <span class="relative">
                            ...
                            <span class="group-hover:text-gold relative text-gray-300 transition-colors duration-300">Home</span>
                        </span>
                    </a>
                    <a href="/gallery" class="nav-link-hover group px-4 py-2">
                        <span class="relative">
                            <span class="bg-gold absolute inset-x-0 -bottom-1 h-0.5 origin-left scale-x-0 transform transition-transform duration-300 group-hover:scale-x-100"></span>
                            <span class="group-hover:text-gold relative text-gray-300 transition-colors duration-300">Gallery</span>
                        </span>
                    </a>
                    ...
                    <a href="/contact" class="nav-link-hover group px-4 py-2">
                        <span class="relative">
                            <span class="bg-gold absolute inset-x-0 -bottom-1 h-0.5 origin-left scale-x-0 transform transition-transform duration-300 group-hover:scale-x-100"></span>
                            <span class="group-hover:text-gold relative text-gray-300 transition-colors duration-300">Contact</span>
                        </span>
                    </a>
                </div>
            ...
            <div class="xl:grid xl:grid-cols-3 xl:gap-8">
                ...
                <div class="mt-12 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
                    <div class="md:grid md:grid-cols-2 md:gap-8">
                        <div>
                            <h3 class="font-playfair text-gold text-sm font-semibold uppercase tracking-wider">Quick Links</h3>
                        ...
                        <div class="mt-12 md:mt-0">
                            <h3 class="font-playfair text-gold text-sm font-semibold uppercase tracking-wider">Support</h3>
                            <ul class="mt-4 space-y-4">
                                <li><a href="/contact" class="hover:text-gold text-sm text-gray-400">Contact</a></li>
                                <li><a href="#" class="hover:text-gold text-sm text-gray-400">Privacy Policy</a></li>
                                <li><a href="#" class="hover:text-gold text-sm text-gray-400">Terms & Conditions</a></li>
