<div>
    ...
    <div x-transition:enter="transition duration-300 ease-in-out" x-transition:enter-start="opacity-0"
        ...
        x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" x-show="isViewDetailPanelOpen"
        @click="isViewDetailPanelOpen = false" class="bg-red-darker fixed inset-0 z-10" style="opacity: 0.5"
    ...
    <section x-transition:enter="transition duration-300 ease-in-out transform sm:duration-500"
        ...
        tabindex="-1" x-show="isViewDetailPanelOpen" @keydown.escape="isViewDetailPanelOpen = false"
    ...
    @script
        <script>
            $wire.on('viewDetail', function(data) {
                openViewDetailPanel()
                console.log(data);
            });
        </script>
