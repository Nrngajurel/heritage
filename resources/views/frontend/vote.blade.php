            ...
            <div class="border-gold/20 mx-4 w-full max-w-lg transform rounded-lg border bg-neutral-900 p-6 transition-all duration-300 hover:scale-[1.02]">
                ...
                <div class="flex flex-col items-center gap-4 sm:gap-5">
                    ...
                    <div class="flex flex-col items-center gap-4 sm:gap-5">
                        ...
                        <div class="mx-auto grid w-full max-w-xl grid-cols-5 gap-3 px-2 py-3 sm:gap-4 sm:p-3">
                            <p class="col-span-5 mb-2 text-center text-sm text-gray-400 sm:mb-3 sm:text-base"
                                x-text="`Share ${activeShare ? activeShare.name : ''} Journey`"></p>
                            <a :href="`https://www.instagram.com/create/story?url=${voteUrl}`"
                                class="social-share-btn bg-gold/10 hover:bg-gold/20 hover:shadow-gold/10 flex h-12 w-12 items-center justify-center rounded-full transition-all duration-300 hover:shadow-lg sm:h-14 sm:w-14"
                            ...
                            <a :href="`https://twitter.com/intent/tweet?url=${voteUrl}&text=Vote for ${activeShare?.name} in Miss Heritage International!`"
                                class="social-share-btn bg-gold/10 hover:bg-gold/20 hover:shadow-gold/10 flex h-10 w-10 items-center justify-center rounded-full transition-all duration-300 hover:shadow-lg sm:h-12 sm:w-12"
            ...
            <div class="mx-auto max-w-7xl">
                ...
                <div class="mb-16" x-data="{
                    ...
                    <div class="mx-auto grid gap-4 px-4 sm:grid-cols-3 lg:gap-6">
                        <!-- Total Votes -->
                        <div class="pageant-card group relative col-span-2 overflow-hidden rounded-2xl p-4 transition-all duration-500 hover:scale-[1.02] hover:shadow-[0_0_50px_0_rgba(255,215,0,0.15)] sm:p-6 md:col-span-1"
                            x-data="{ isHovered: false }" @mouseenter="isHovered = true" @mouseleave="isHovered = false">
                            <!-- Background Effects -->
                            <div
                                class="from-gold/10 via-gold/5 to-gold/10 absolute inset-0 bg-gradient-to-br opacity-0 transition-opacity duration-500 group-hover:opacity-100">
                            </div>
                            ...
                            <div class="relative flex flex-col items-center justify-center space-y-3">
                                ...
                                <div class="text-gold text-3xl font-bold transition-all duration-300 group-hover:scale-110 sm:text-4xl lg:text-5xl"
                        ...
                        <div class="pageant-card group relative col-span-2 overflow-hidden rounded-2xl p-4 transition-all duration-500 hover:scale-[1.02] hover:shadow-[0_0_50px_0_rgba(255,215,0,0.15)] sm:col-span-1 sm:p-6"
                            ...
                            <div class="relative space-y-3">
                                <div class="text-gold/60 text-center text-sm font-medium uppercase tracking-wider">Time
                                    Remaining</div>
                                <div class="grid grid-cols-4 gap-2 sm:gap-3">
                                    <div class="text-center">
                                        <div
                                            class="relative overflow-hidden rounded-lg bg-black/20 p-2 backdrop-blur-sm transition-all duration-300 group-hover:bg-black/30">
                                            <span
                                                class="text-gold bg-gradient-to-r from-amber-200 to-yellow-500 bg-clip-text text-xl font-bold text-transparent sm:text-2xl lg:text-3xl"
                                            ...
                                            <div class="absolute bottom-0 left-0 right-0 p-6 text-center">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <h3 class="font-playfair mb-2 text-2xl font-bold text-white">
                                                        {{ $contestant['name'] }}</h3>
                                                    <p class="text-gold text-lg font-medium">Currently
                                                        #{{ $index + 1 }}
                                                    </p>
                                                ...
                                                <button @click.prevent='activeShare = @json($contestant)'
                                                    class="text-gold hover:text-gold/80 mt-3 flex w-full items-center justify-center space-x-2 text-sm transition">
                                                    <svg class="text-gold h-4 w-4" fill="currentColor"
                                                        viewBox="0 0 24 24">
                                                        <path
                        ...
                        <div class="pageant-card group"
                            ...
                            <a href="{{ route('vote.show', $contestant['id']) }}" class="block">
                                ...
                                <div class="p-6">
                                    ...
                                    <button @click.prevent='activeShare = @json($contestant)'
                                        class="text-gold hover:text-gold/80 mt-3 flex w-full items-center justify-center space-x-2 text-sm transition">
                                        <svg class="text-gold h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                                            <path
                                                d="M18 16.08c-.76 0-1.44.3-1.96.77L8.91 12.7c.05-.23.09-.46.09-.7s-.04-.47-.09-.7l7.02-4.11a3 3 0 1 0-.91-1.45L8.09 9.85a3 3 0 1 0 0 4.3l7.1 4.16A3 3 0 1 0 18 16.08z" />
                                        </svg>
                                        <span>Share</span>
