                ...
                <div class="grid gap-12 lg:grid-cols-2">
                    ...
                    <div class="space-y-8">
                        <div>
                            ...
                            <div class="from-gold to-gold/50 mt-2 h-1 w-20 bg-gradient-to-r"></div>
                        </div>

                        <div class="space-y-6 text-gray-300">
                            <div class="flex items-start space-x-4">
                                <div class="bg-gold/10 text-gold rounded-full p-3">
                            ...
                            <div class="mt-4 flex space-x-4">
                                @foreach (setting()->social_links as $link)
                                    @if (isset($link['url']) && $link['url'])
                                        <a href="{{ $link['url'] }}" class="hover:text-gold pr-2 text-gray-400"
                                            ...
                                            @elseif($link['platform'] == 'tiktok')
                                                <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" fill="none"
                        ...
                        <form action="{{ route('contact.submit') }}" method="POST" class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="name" id="name" required
                                    class="focus:border-gold focus:ring-gold mt-1 block w-full rounded-md border-gray-700 bg-gray-800 text-white placeholder-gray-400"
                            ...
                            <button type="submit"
                                class="from-gold to-gold/80 hover:shadow-gold/20 w-full transform rounded-full bg-gradient-to-r px-8 py-3 text-sm font-semibold text-white transition-all hover:scale-105 hover:shadow-lg">
                                Send Message
                            </button>
                        </form>
                    </div>
