            ...
            <div class="mt-24">
                ...
                <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div class="group relative overflow-hidden rounded-2xl bg-gray-800/20 backdrop-blur-sm transition-all duration-300">
                        ...
                        <div class="p-6">
                            <h3 class="text-gold mb-2 text-2xl font-bold">Susan Koh</h3>
                            <p class="text-gold/60 text-lg">International Event Director</p>
                        </div>
                    </div>
                    ...
                    <div class="group relative overflow-hidden rounded-2xl bg-gray-800/20 backdrop-blur-sm transition-all duration-300">
                        ...
                        <div class="p-6">
                            <h3 class="text-gold mb-2 text-2xl font-bold">Culvin Mavunga</h3>
                            <p class="text-gold/60 text-lg">President</p>
                        </div>
                    </div>
                </div>
            </div>
