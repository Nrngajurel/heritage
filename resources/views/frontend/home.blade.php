...
@section('content')
    ...
    <section class="bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 px-4 py-12 text-center sm:px-6 lg:px-8">
        <div class="container mx-auto px-4">
            <h1 class="pageant-heading mb-4 text-2xl font-extrabold tracking-tight sm:text-3xl md:text-4xl lg:text-5xl">
                PAGEANT OF HERITAGE</h1>
            <div class="mx-auto mb-12 text-white">
                <p class="mb-6 mt-10 text-gray-200">Pageant of Heritage is an ultimate international beauty pageant that
    ...
    <section class="bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 px-4 py-12 sm:px-6 lg:px-8">
        <div class="container mx-auto px-4">
            <div class="fade-up relative overflow-hidden rounded-lg">
                <img src="https://i.ytimg.com/vi_webp/uvUqpB1wp1w/mqdefault.webp" class="h-full w-full object-cover"
                    alt="Heritage Pageant Video">
                <div class="absolute inset-0 bg-black/50"></div>
                <button
                    class="absolute inset-0 flex transform items-center justify-center transition duration-300 hover:scale-110"
                    ...
                    <svg width="200px" height="200px" viewBox="0 0 24 24" fill="none"
                        ...
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            fill="#e4cb86" style="filter: drop-shadow(0 0 10px #e4cb86); animation: pulse 2s infinite;" />
                    </svg>
                </button>
    ...
    <section class="bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 px-4 py-12 sm:px-6 lg:px-8">
        <div class="container mx-auto px-4">
            ...
            <p class="text-gold/70 mb-8 text-center text-lg italic">Celebrating the Legacy of Excellence and Grace</p>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <h3 class="text-xl font-semibold text-[#e4cb86] drop-shadow-lg">Heritage Queen
                                            {{ 2024 - $index }}
                                        </h3>
                                    </div>
                                </div>
    ...
    <section class="my-10 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 px-4 sm:px-6 lg:px-8">
        <div class="container mx-auto px-4">
            <h2
                class="pageant-heading mb-4 text-center text-2xl font-extrabold tracking-tight sm:text-3xl md:text-4xl lg:text-5xl">
                MOMENTS</h2>
            <p class="text-gold/70 mb-8 text-center text-lg italic">Capturing the Magic and Elegance of Heritage Pageants</p>
    ...
    <section class="bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 px-4 py-20 sm:px-6 lg:px-8">
        <div class="container mx-auto px-4">
            ...
            <p class="text-gold/70 mb-8 text-center text-lg italic">Celebrating Our Most Memorable Heritage Moments</p>
    ...
    <section class="bg-black py-12">
        <div class="container mx-auto px-4">
            <div class="text-left uppercase">
                <h2 class="text-xl text-white">News Media Coverage</h2>
    ...
    <section class="bg-gray-900 py-12">
        <div class="container mx-auto px-4">
            <div class="text-left uppercase">
                ...
                <p class="mb-8 text-sm normal-case text-gray-400">Stay updated with our latest stories from Heritage Pageants</p>
            </div>
            <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                @foreach ([
            [
