    ...
    >
      <div class="flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
        ...
        <aside
          ...
          tabindex="-1"
          class="fixed inset-y-0 z-10 flex-shrink-0 w-64 bg-white border-r lg:static dark:border-red-darker dark:bg-darker focus:outline-none"
        >
        ...
        <section
          ...
          tabindex="-1"
          class="fixed inset-y-0 z-10 flex-shrink-0 w-64 bg-white border-r dark:border-red-darker dark:bg-darker lg:static focus:outline-none"
          aria-labelledby="secondSidebarHeader"
        >
          <div class="flex flex-col h-screen">
            <!-- Panel header -->
            <div class="flex-shrink-0">
              <div class="px-4 pt-4 border-b dark:border-red-darker">
