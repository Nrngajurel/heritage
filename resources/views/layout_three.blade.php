  ...
  <body>
    ...
    >
      <div class="flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
        ...
        <div
          x-ref="loading"
          class="fixed inset-0 z-50 flex items-center justify-center text-2xl font-semibold text-white bg-red-darker"
        >
          Loading.....
        </div>
        ...
        <div
          ...
          class="fixed inset-0 z-10 bg-red-darker md:hidden"
          style="opacity: 0.5"
          aria-hidden="true"
        ></div>
        ...
        <aside
          ...
          tabindex="-1"
          class="fixed inset-y-0 z-10 flex flex-shrink-0 bg-white border-r md:static dark:border-red-darker dark:bg-darker focus:outline-none"
        >
          <!-- Mini column -->
          <nav class="flex flex-col flex-shrink-0 h-full px-2 py-4 border-r dark:border-red-darker">
            <!-- Brand -->
            <div class="flex-shrink-0">
              <a
                href="../index.html"
                class="inline-block text-xl font-bold tracking-wider uppercase text-red-dark dark:text-light"
              >
                K-WD
              </a>
            </div>
            <div class="flex flex-col items-center justify-center flex-1 space-y-4">
              <!-- Home link -->
              <!-- Active classes "bg-red text-white" -->
              <!-- inActive classes "bg-red-50 text-red-lighter" -->
              <a
                href="#"
                class="p-2 text-white transition-colors duration-200 rounded-full bg-red hover:text-red hover:bg-red-100 dark:hover:text-light dark:hover:bg-red-dark dark:bg-dark focus:outline-none focus:bg-red-100 dark:focus:bg-red-dark focus:ring-red-darker"
              >
              ...
              <a
                href="#"
                class="p-2 transition-colors duration-200 rounded-full text-red-lighter bg-red-50 hover:text-red hover:bg-red-100 dark:hover:text-light dark:hover:bg-red-dark dark:bg-dark focus:outline-none focus:bg-red-100 dark:focus:bg-red-dark focus:ring-red-darker"
              >
        ...
        <div class="flex flex-1 h-screen overflow-y-scroll">
            ...
            <header class="flex items-center justify-between p-4">
              <div class="flex items-center space-x-4 md:space-x-0">
                ...
                <button
                  ...
                  class="p-1 transition-colors duration-200 rounded-md text-red-lighter bg-red-50 md:hidden hover:text-red hover:bg-red-100 dark:hover:text-light dark:hover:bg-red-dark dark:bg-dark focus:outline-none focus:ring"
                >
              ...
              <div class="space-x-2">
                ...
                <button aria-hidden="true" class="relative focus:outline-none" x-cloak @click="toggleTheme">
                  <div
                    class="w-12 h-6 transition bg-red-100 rounded-full outline-none dark:bg-red-lighter"
                  ></div>
                  <div
                    ...
                    :class="{ 'translate-x-0 -translate-y-px  bg-white text-red-dark': !isDark, 'translate-x-6 text-red-100 bg-red-darker': isDark }"
                  >
                    <svg
                      x-show="!isDark"
                      class="w-4 h-4"
                ...
                <button
                  ...
                  class="p-1 transition-colors duration-200 rounded-md text-red-lighter bg-red-50 hover:text-red hover:bg-red-100 dark:hover:text-light dark:hover:bg-red-dark dark:bg-dark focus:outline-none focus:ring"
                >
                ...
                <button
                  @click="openUserPanel"
                  class="p-1 transition-colors duration-200 rounded-md text-red-lighter bg-red-50 xl:hidden hover:text-red hover:bg-red-100 dark:hover:text-light dark:hover:bg-red-dark dark:bg-dark focus:outline-none focus:ring"
                >
          ...
          <section
            ...
            tabindex="-1"
            x-ref="userPanel"
            class="fixed inset-y-0 top-0 right-0 z-10 flex-shrink-0 bg-white xl:z-0 xl:sticky w-80 dark:bg-darker dark:text-light xl:border-l dark:border-red-darker focus:outline-none"
          >
            ...
            <div class="flex flex-col h-screen">
                  ...
                  <div class="space-y-4">
                    <a href="#" class="flex items-start space-x-2 group">
                      ...
                      <div class="overflow-hidden">
                        <h4
                          class="font-semibold text-gray-400 transition-colors dark:text-red-dark group-hover:text-gray-900 dark:group-hover:text-red-lighter"
                        >
                          John Doe
                        </h4>
                      ...
                      <span class="text-xs text-gray-500 whitespace-nowrap dark:text-red-light">1h ago</span>
                    </a>
                    <a href="#" class="flex items-start space-x-2 group">
                      <img
                        class="flex-shrink-0 object-cover w-12 h-12 rounded-full"
              ...
              <!-- Panel footer -->
              <footer
                class="flex items-center justify-between flex-shrink-0 px-4 py-2 border-t dark:border-red-darker"
              >
                <div class="text-sm">
                  View on
                  <a
        ...
        <div
          ...
          class="fixed inset-0 z-10 bg-red-darker"
          style="opacity: 0.5"
          aria-hidden="true"
        ></div>
        <!-- Panel -->
        ...
        >
          ...
          <div class="flex flex-col h-screen">
            <!-- Panel header -->
            <div
              class="flex flex-col items-center justify-center flex-shrink-0 px-4 py-8 space-y-4 border-b dark:border-red-dark"
            >
              <span aria-hidden="true" class="text-gray-500 dark:text-red">
                <svg
                  class="w-8 h-8"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
            ...
            <div class="flex-1 overflow-hidden hover:overflow-y-auto">
              ...
              <div class="p-4 space-y-4 md:p-8">
                ...
                <div class="flex items-center space-x-8">
                  ...
                  <button
                    @click="setLightTheme"
                    class="flex items-center justify-center px-4 py-2 space-x-4 transition-colors border rounded-md hover:text-gray-900 hover:border-gray-900 dark:border-red dark:hover:text-red-100 dark:hover:border-red-light focus:outline-none focus:ring focus:ring-red-lighter focus:ring-offset-2 dark:focus:ring-offset-dark dark:focus:ring-red-dark"
                    :class="{ 'border-gray-900 text-gray-900 dark:border-red-light dark:text-red-100': !isDark, 'text-gray-500 dark:text-red-light': isDark }"
                  >
                    <span>
                      <svg
                        class="w-6 h-6"
        ...
        >
          ...
          <div class="flex flex-col h-screen">
            ...
            <div
              class="relative flex-shrink-0 px-4 py-8 text-gray-400 border-b dark:border-red-darker dark:focus-within:text-light focus-within:text-gray-700"
            >
